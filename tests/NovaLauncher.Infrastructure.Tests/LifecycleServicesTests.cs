...
public sealed class LifecycleServicesTests : IDisposable
{
    ...
    public async Task UpdateCheckAcceptsOnlyNewerOfficialChannelAsset()
    {
        ...
        handler.AddJson("api.github.com", ReleasesJson("v1.3.0-beta.1", true, installer.Length));
        ...
        Assert.Equal("v1.3.0-beta.1", Assert.IsType<UpdateRelease>(beta.Release).Tag);
    }
