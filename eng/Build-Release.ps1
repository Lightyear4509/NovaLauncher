...
$portable = Join-Path $release 'NovaLauncher-0.2.0-alpha.1-win-x64-portable.zip'
...
& (Join-Path $PSScriptRoot 'New-Sbom.ps1') -OutputPath (Join-Path $release 'NovaLauncher-0.2.0-alpha.1.cdx.json')
